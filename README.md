...
exa is written in [Rust](http://www.rust-lang.org). You will need rust version 1.17.0 or higher. The recommended way to install Rust is from the official download page.
